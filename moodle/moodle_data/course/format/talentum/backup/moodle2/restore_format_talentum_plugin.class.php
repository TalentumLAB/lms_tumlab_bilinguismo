 ...
 */
class restore_format_talentum_plugin extends restore_format_plugin{ 
    ...
    protected function define_course_plugin_structure() {
        ...
        // only has a /talentum_format element).
        $elepath = $this->get_pathfor('/talentum_format');

        // The 'lazystudents' here defines that it will use the
        // process_lazystudents function to restore its element.
        $paths[] = new restore_path_element('talentum_format', $elepath);
    ...
    function after_execute_course() {
        ...
        $this->add_related_files('format_talentum_format', 'images', null);
    }

    /**
     * Process the 'lazystudents' element
     */
    public function process_talentum_format($data) {
        global $DB;
