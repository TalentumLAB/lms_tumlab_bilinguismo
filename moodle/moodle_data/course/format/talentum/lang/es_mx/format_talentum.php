...
$string['Coursecontent']  = 'Enlace del programa de curso';
$string['Coursecontent_help']  = 'Colocar el enlace del PDF del programa de curso';
$string['Courseprocess']  = 'Enlace del proceso evaluativo';
...
$string['moduletitle']  = 'Título del módulo - {$a}';
$string['moduletitle_help']  = 'Título del módulo - {$a} para contextualizar al estudiante';
$string['moduleimage']  = 'Enlace de la imágen del módulo';
$string['moduleimage_help']  = 'Enlace de la imágen del módulo que quiere que aparezca en el contenedor del módulo';
$string['textselect']  = 'Id del video que aparecera en el módulo - {$a}';
$string['textselect_help']  = 'Id del video que quiere que aparezca en el módulo {$a}';
$string['modulevideo']  = 'Id del video que aparecera en el módulo - {$a}';
$string['modulevideo_help']  = 'Id del video que quiere que aparezca en el módulo {$a}';
$string['moduleobjetive']  = 'Objetivo del módulo - {$a}';
$string['moduleobjetive_help']  = 'Objetivo del módulo - {$a} que quiere que aparezca en el módulo {$a}';
...
$string['divisortext'] = 'Título del módulo - {$a}';
...
$string['no'] = 'No';
$string['pluginname'] = 'Formato Talentum';
